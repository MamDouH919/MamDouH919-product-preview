...
export default function ProductDetailClient({ params }: Props) {
  ...
  const activeVariant = selectedVariant ?? (product?.variants?.length ? 0 : null)
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16">
          ...
          <div className="flex flex-col gap-5">
            ...
            {(() => {
              const displayPrice = activeVariant !== null
            ...
            {product.variants?.length > 0 && (
              <div className="flex flex-col gap-2">
                <span className="text-sm font-medium text-gray-500">{t("variants")}</span>
                <div className="flex flex-wrap gap-2">
